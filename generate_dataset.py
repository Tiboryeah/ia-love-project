...
character = {
    "id": "sweet-coco",
    "base_identity": "stunning beautiful blonde woman, perfect face, symmetrical features, cinematic lighting, high quality, masterpiece",
...
prompts = [
    ...
    ("casual", "medium shot of {identity}, wearing casual white t-shirt, standing in a sunny room"),
    ("gym", "medium shot of {identity}, wearing tight sports bra and shorts, gym wall background, selfie"),
    ("elegant", "medium shot of {identity}, wearing elegant black evening dress, luxury background"),
    ("lingerie", "medium shot of {identity}, wearing delicate lace lingerie, bedroom background"),
    ("bikini", "medium shot of {identity}, wearing tiny red bikini, beach background, sunny day"),
    
    # Cuerpo entero
    ("full_body_jeans", "full body photo of {identity}, standing, wearing ripped jeans and crop top"),
    ("full_body_dress", "full body photo of {identity}, walking, wearing summer dress, outdoor street"),
...
for idx, (name, prompt_template) in enumerate(prompts):
    ...
    payload = {
        ...
        "seed": 100 + idx,  # Variamos la semilla para mayor naturalidad
        "send_images": True,
    }
