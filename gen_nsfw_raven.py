...
character = {
    "id": "raven-egirl",
    "base_identity": "stunningly beautiful 20 year old e-girl goth woman, very pale skin, black hair with bangs and twin braids, heavy e-girl makeup, thick dark winged eyeliner, black choker, black and white striped crop top, intensely ripped black tights, slim fit body, perfect cute face, symmetrical features",
    "negative": "deformed, ugly, monster, horror, blurry, lowres, low quality, worst quality, bad anatomy, bad proportions, duplicate, morbid, mutilated, extra fingers, mutated hands, poorly drawn hands, poorly drawn face, mutation, deformed, ugly, bad proportions, gross proportions, text, watermark, clothes, censored"
}
...
nsfw_prompts = [
    ...
    ("nsfw_detail_breasts", "extreme close up of beautiful perky breasts, {identity}, completely naked torso, detailed nipples, realistic skin texture, soft lighting"),
    ...
    ("nsfw_detail_thighs", "close up of thighs and hips with ripped tights ripped off, {identity}, completely naked, standing pose, smooth skin, 8k resolution"),
    
    # Pies y manos
    ("nsfw_detail_feet", "close up of bare feet, 5 toes, detailed soles, {identity} completely naked sitting on bed, highly detailed, perfect anatomy"),
    ("nsfw_detail_hands", "close up of beautiful hands with manicured black nails resting on naked body, {identity}, perfect hands anatomy, 5 fingers, realistic skin"),

    # Expresiones intimas
    ("nsfw_giving_bj", "close up of {identity} face looking up, mouth open, seductive facial expression, ahegao, glowing skin, intimate lighting"),
...
print(f"Generating 12 high-quality NSFW training images for {character['id']}...")
    ...
    try:
        ...
        if response.ok:
            ...
            if "images" in data and len(data["images"]) > 0:
                ...
                import json
                print(f"Error, info json: {data.get('info')}")
        else:
