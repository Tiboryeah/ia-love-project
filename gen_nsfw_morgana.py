...
character = {
    "id": "morgana-goth",
    "base_identity": "stunningly beautiful 20 year old gothic woman, extremely pale skin, huge breasts, long black hair, heavy eyeliner, black lips, perfect face, symmetrical features",
    "negative": "deformed, ugly, monster, horror, blurry, low quality, clothes, censored, text, watermark, extra fingers, extra toes, mirror, clone"
}
...
nsfw_prompts = [
    ...
    ("nsfw_pose_cowgirl", "photo of {identity} straddling, cowgirl pose, sitting on top, completely naked, visible huge breasts and completely naked body, looking at camera"),
    ...
    ("nsfw_detail_breasts", "extreme close up of beautiful huge breasts, {identity}, completely naked torso, detailed nipples, realistic skin texture, soft lighting"),
